...
#### Story 2.1: Signal File Generation
- **Given**: Running signal generator
- **When**: Market conditions trigger a signal
- **Then**: JSON file should be created/updated
- **Acceptance Criteria**:
  - [ ] signals.json created in MQL5/Files/
  - [ ] Valid JSON format with all required fields
  - [ ] Timestamp updates with each signal
  - [ ] Signal confidence scores included

#### Story 2.2: EA Signal Processing
- **Given**: Valid signal file exists
